...
!!! abstract "Key takeaways"
    ...
    - Fill model III adds square-root impact: on SPY's real $28.9bn ADV, $1M pays 0.8 bp, $100M pays 7.5 bp, $1bn pays 23.8 bp — sublinear in size, which is why execution schedules exist, and twenty times gentler than the sector ETFs of Part IV.
